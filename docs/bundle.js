...
class Api {
  ...
  getPoints() {
    return this._load({url: `points`})
      .then(Api.toJSON)
      .then((points) => points.map(_model_points_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptPointToClient));
  }
  ...
  updatePoint(point) {
    return this._load({
      url: `points/${point.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_points_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptPointToServer(point)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then(_model_points_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptPointToClient);
  }
  ...
  addPoint(newPoint) {
    return this._load({
      url: `points`,
      method: Method.POST,
      body: JSON.stringify(_model_points_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptPointToServer(newPoint)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then(_model_points_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptPointToClient);
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: RenderPosition, UpdateType, SortType, FilterType, EventType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _model_filters_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/filters.js */ "./src/model/filters.js");
/* harmony import */ var _model_points_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./model/points.js */ "./src/model/points.js");
/* harmony import */ var _model_offers_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/offers.js */ "./src/model/offers.js");
/* harmony import */ var _model_destinations_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./model/destinations.js */ "./src/model/destinations.js");
/* harmony import */ var _presenter_controls_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./presenter/controls.js */ "./src/presenter/controls.js");
/* harmony import */ var _presenter_events_list_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./presenter/events-list.js */ "./src/presenter/events-list.js");
...
const api = new _api_api_js__WEBPACK_IMPORTED_MODULE_1__["default"](END_POINT, AUTHORIZATION);

const filtersModel = new _model_filters_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const pointsModel = new _model_points_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const offersModel = new _model_offers_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
const destinationsModel = new _model_destinations_js__WEBPACK_IMPORTED_MODULE_5__["default"]();

const controlsPresenter = new _presenter_controls_js__WEBPACK_IMPORTED_MODULE_6__["default"](headerElement, pointsModel, filtersModel);
const eventsListPresenter = new _presenter_events_list_js__WEBPACK_IMPORTED_MODULE_7__["default"](tripEventsElement, pointsModel, offersModel, destinationsModel, filtersModel, api);

api.getPoints()
  .then((points) => {
    pointsModel.collection = {updateType: _const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].INIT, updatedData: points};
  })
  .catch(() => {
    pointsModel.collection = {updateType: _const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].INIT, updatedData: []};
  });

api.getOffers()
  .then((offers) => {
    offersModel.collection = {updateType: _const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].INIT, updatedData: offers};
  })
  .catch(() => {
    offersModel.collection = {updateType: _const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].INIT, updatedData: []};
  });

api.getDestinations()
  .then((destinations) => {
    destinationsModel.collection = {updateType: _const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].INIT, updatedData: destinations};
  })
  .catch(() => {
    destinationsModel.collection = {updateType: _const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].INIT, updatedData: []};
  });
...
class Filters extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._selected = _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING;
  }
...
class Points extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  updatePoint(updateType, updatedPoint) {
    ...
    this._collection = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["updateItem"])(this._collection, updatedPoint, index);
  ...
  deletePoint(updateType, deletedPoint) {
    ...
    this._collection = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["deleteItem"])(this._collection, index);
...
/* harmony import */ var _view_controls_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/controls.js */ "./src/view/controls.js");
...
class Controls {
  constructor(container, pointsModel, filtersModel) {
    ...
    this._filterSelected = _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].EVERYTHING;

    this._pointsModel = pointsModel;
    this._filtersModel = filtersModel;

    this._controlsComponent = new _view_controls_js__WEBPACK_IMPORTED_MODULE_2__["default"](this._filterSelected);
    this._tripInfoComponent = new _view_trip_info_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  init() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._controlsElement, this._controlsComponent);
  }

  _handlePointsModelEvent(updateType, updatedData) {
    switch (updateType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].MINOR:
      case _const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].MAJOR:
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._tripInfoComponent);
        this._tripInfoComponent.points = this._pointsModel.collection;
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._tripInfoComponent, _const_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].INIT:
  ...
  _changeFilterHandler(newFilter) {
    if (newFilter !== this._filtersModel.selected) {
      this._filtersModel.selected = {updateType: _const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].MAJOR, updatedData: newFilter};
    }
  }
}
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _view_event_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/event.js */ "./src/view/event.js");
/* harmony import */ var _view_event_editor_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/event-editor.js */ "./src/view/event-editor.js");
...
/* harmony import */ var _view_no_events_plug_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/no-events-plug.js */ "./src/view/no-events-plug.js");
/* harmony import */ var _view_loading_plug_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../view/loading-plug.js */ "./src/view/loading-plug.js");
...
class EventsList {
  constructor(container, pointsModel, offersModel, destinationsModel, filtersModel, api) {
    ...
    this._sortTypeSelected = _const_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].BY_DAY;
    this._addEventButtonElement = document.querySelector(`.trip-main__event-add-btn`);
    this._isAddEventButtonClicked = false;

    this._eventEditorCompoment = new _view_event_editor_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._eventListComponent = new _view_events_list_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._sortingComponent = new _view_sorting_js__WEBPACK_IMPORTED_MODULE_4__["default"](this._sortTypeSelected);
    this._noEventsPlugViewComponent = new _view_no_events_plug_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
    this._loadingPlugComponent = new _view_loading_plug_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
  ...
  init() {
    ...
    if (!this._isLoaded) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._loadingPlugComponent);
    ...
    if (this._getPoints().length > 0 || this._isAddEventButtonClicked) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._sortingComponent);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._eventListComponent);

      this._getPoints().forEach((point) => {
        const eventComponent = new _view_event_js__WEBPACK_IMPORTED_MODULE_2__["default"](Object.assign(
            {},
            point,
            {offers: point.offers},
        ...
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._eventListComponent, eventComponent);
      });
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._noEventsPlugViewComponent);
    }
  }

  _clearList() {
    if (!this._isLoaded) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._loadingPlugComponent);
    ...
    if (this._container.contains(this._eventListComponent.getElement())) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._eventListComponent);
    }

    if (this._container.contains(this._noEventsPlugViewComponent.getElement())) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._noEventsPlugViewComponent);
    }
  ...
  _getPoints() {
    ...
    if (this._filtersModel.selected !== _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].EVERYTHING) {
      points = points.filter((point) => {
        let isFiltered;
        switch (this._filtersModel.selected) {
          case _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FUTURE:
            isFiltered = dayjs__WEBPACK_IMPORTED_MODULE_8___default()(point.dateFrom).diff(dayjs__WEBPACK_IMPORTED_MODULE_8___default()()) >= 0;
            break;
          case _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].PAST:
            isFiltered = dayjs__WEBPACK_IMPORTED_MODULE_8___default()().diff(dayjs__WEBPACK_IMPORTED_MODULE_8___default()(point.dateFrom)) > 0;
            break;
        }
    ...
    switch (this._sortTypeSelected) {
      case _const_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].BY_DAY:
        points.sort((a, b) => {
          return dayjs__WEBPACK_IMPORTED_MODULE_8___default()(a.dateFrom).diff(dayjs__WEBPACK_IMPORTED_MODULE_8___default()(b.dateFrom));
        });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].BY_TIME:
        points.sort((a, b) => {
          const firstItemDateFrom = dayjs__WEBPACK_IMPORTED_MODULE_8___default()(a.dateFrom);
          const firstItemDateTo = dayjs__WEBPACK_IMPORTED_MODULE_8___default()(a.dateTo);

          const secondItemDateFrom = dayjs__WEBPACK_IMPORTED_MODULE_8___default()(b.dateFrom);
          const secondItemDateTo = dayjs__WEBPACK_IMPORTED_MODULE_8___default()(b.dateTo);

          return secondItemDateTo.diff(secondItemDateFrom) - firstItemDateTo.diff(firstItemDateFrom);
        });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].BY_PRICE:
        points.sort((a, b) => {
  ...
  _changeEventFavoriteStatusHandler(point) {
    this._api.updatePoint(point)
      .then((updatedData) => {
        this._pointsModel.updatePoint(_const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].PATCH, updatedData);
      })
      .catch(() => {
  ...
  _openEventEditorHandler(point) {
    if (this._eventEditorCompoment.point !== null) {
      ...
      if (this._eventEditorCompoment.point.hasOwnProperty(`id`)) {
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._eventComponents.get(this._eventEditorCompoment.point.id), this._eventEditorCompoment);
      }

      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._eventEditorCompoment);
    }
    ...
    if (!point.hasOwnProperty(`id`)) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._eventListComponent, this._eventEditorCompoment, _const_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._eventEditorCompoment, this._eventComponents.get(point.id));
  }

  _closeEventEditorHandler(point) {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._eventComponents.get(point.id), this._eventEditorCompoment);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._eventEditorCompoment);
  ...
  _saveEditedEventHandler(point) {
    if (!point.hasOwnProperty(`id`)) {
      this._api.addPoint(point)
        .then((newPoint) => {
          this._pointsModel.addPoint(_const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].MAJOR, newPoint);
        })
        .catch(() => {
    ...
    this._api.updatePoint(point)
      .then((updatedData) => {
        this._pointsModel.updatePoint(_const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].MINOR, updatedData);
      })
      .catch(() => {
  ...
  _deleteEditedEventHandler(point) {
    ...
    this._api.deletePoint(point)
      .then(() => {
        this._pointsModel.deletePoint(_const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].MINOR, point);
      })
      .catch(() => {
  ...
  _handleModelEvent(updateType, updatedData) {
    switch (updateType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_0__["UpdateType"].PATCH:
  ...
  _addEventButtonHandler(evt) {
    ...
    const emptyPoint = {
      basePrice: -1,
      dateFrom: dayjs__WEBPACK_IMPORTED_MODULE_8___default()(),
      dateTo: dayjs__WEBPACK_IMPORTED_MODULE_8___default()(),
      destination: null,
      isFavorite: false,
      offers: [],
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: updateItem, deleteItem, isOnline */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const render = (containerElement, childElement, position = `beforeend`) => {
  containerElement = containerElement instanceof _view_abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] ? containerElement.getElement() : containerElement;
  childElement = childElement instanceof _view_abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] ? childElement.getElement() : childElement;

  switch (position) {
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN:
...
const renderTemplate = (containerElement, template, position = `beforeend`) => {
  containerElement = containerElement instanceof _view_abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] ? containerElement.getElement() : containerElement;
...
const replace = (newChildElement, oldChildElement) => {
  if (oldChildElement instanceof _view_abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"]) {
    oldChildElement = oldChildElement.getElement();
  }

  if (newChildElement instanceof _view_abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"]) {
...
class Abstract {
  ...
  getElement() {
    this._element = this._element ? this._element : Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["createElement"])(this.getTemplate());
  ...
  return `<div>
            ...
            <form class="trip-filters" action="#" method="get">
              <div class="trip-filters__filter">
                <input id="filter-everything" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="everything"${filterSelected === _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING ? ` checked=""` : ``}>
                <label class="trip-filters__filter-label" for="filter-everything">Everything</label>
              </div>

              <div class="trip-filters__filter">
                <input id="filter-future" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="future"${filterSelected === _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FUTURE ? ` checked=""` : ``}>
                <label class="trip-filters__filter-label" for="filter-future">Future</label>
              </div>

              <div class="trip-filters__filter">
                <input id="filter-past" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="past"${filterSelected === _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].PAST ? ` checked=""` : ``}>
...
class Controls extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony import */ var dayjs_plugin_duration__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! dayjs/plugin/duration */ "./node_modules/dayjs/plugin/duration.js");
...
/* harmony import */ var flatpickr_dist_l10n_ru_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! flatpickr/dist/l10n/ru.js */ "./node_modules/flatpickr/dist/l10n/ru.js");
/* harmony import */ var flatpickr_dist_l10n_ru_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(flatpickr_dist_l10n_ru_js__WEBPACK_IMPORTED_MODULE_7__);
...
dayjs__WEBPACK_IMPORTED_MODULE_3___default.a.extend(dayjs_plugin_duration__WEBPACK_IMPORTED_MODULE_4___default.a);
...
const createEvent = ({basePrice = -1, dateFrom = dayjs__WEBPACK_IMPORTED_MODULE_3___default()(), dateTo = dayjs__WEBPACK_IMPORTED_MODULE_3___default()(), destination = null, id = `new-event`, offers = [], type = `taxi`}, offersList, destinationsList) => {
            ...
            <form class="event event--edit" action="#" method="post">
              <header class="event__header">
                ...
                <div class="event__field-group  event__field-group--time">
                  ...
                  <input class="event__input  event__input--time" id="event-start-time-${id}" type="text" name="event-start-time" value="${he__WEBPACK_IMPORTED_MODULE_2___default.a.encode(dayjs__WEBPACK_IMPORTED_MODULE_3___default()(dateFrom).format(`DD/MM/YY HH:mm`))}">
                  —
                  <label class="visually-hidden" for="event-end-time-${id}">To</label>
                  <input class="event__input  event__input--time" id="event-end-time-${id}" type="text" name="event-end-time" value="${he__WEBPACK_IMPORTED_MODULE_2___default.a.encode(dayjs__WEBPACK_IMPORTED_MODULE_3___default()(dateTo).format(`DD/MM/YY HH:mm`))}">
                </div>
                ...
                <div class="event__field-group  event__field-group--price">
                  ...
                  <input class="event__input  event__input--price" id="event-price-${id}" type="text" name="event-price" value="${basePrice < 0 ? `` : he__WEBPACK_IMPORTED_MODULE_2___default.a.encode(basePrice.toString())}">
                </div>
...
class EventEditor extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  ...
  _saveButtonClickHandler(evt) {
    ...
    if (dayjs__WEBPACK_IMPORTED_MODULE_3___default()(this._data.dateTo).diff(dayjs__WEBPACK_IMPORTED_MODULE_3___default()(this._data.dateFrom)) < 0) {
  ...
  _offersChangeHandler(evt) {
    ...
    if (evt.target.checked) {
      ...
      this.updateData({offers: Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["deleteItem"])(this._data.offers, index)}, true);
    }
  ...
  _setDatepicker(evt) {
    ...
    const updateDate = ([userDate]) => {
      ...
      if (evt.target.name === EventTimeName.START) {
        this.updateData({dateFrom: dayjs__WEBPACK_IMPORTED_MODULE_3___default()(userDate).format(`YYYY-MM-DDTHH:mm:ss.SSS`)}, true);
        return;
      }

      this.updateData({dateTo: dayjs__WEBPACK_IMPORTED_MODULE_3___default()(userDate).format(`YYYY-MM-DDTHH:mm:ss.SSS`)}, true);
    };

    this._datepicker = flatpickr__WEBPACK_IMPORTED_MODULE_5___default()(
        evt.target,
        {
          dateFormat: `d/m/y H:i`,
          locale: flatpickr_dist_l10n_ru_js__WEBPACK_IMPORTED_MODULE_7__["Russian"],
          enableTime: true,
          onChange: updateDate,
        }
    );
...
const calculateTimeRange = (dateFrom, dateTo) => {
  dateFrom = dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateFrom);
  dateTo = dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateTo);

  const range = dayjs__WEBPACK_IMPORTED_MODULE_1___default.a.duration(dateTo.diff(dateFrom));
...
const createEvent = ({basePrice, dateFrom, dateTo, destination, isFavorite, offers, type}) => {
  return `<li class="trip-events__item">
            <div class="event">
              <time class="event__date" datetime="${dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateFrom).format(`YYYY-MM-DD`)}">${dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateFrom).format(`MMM DD`)}</time>
              ...
              <div class="event__schedule">
                <p class="event__time">
                  <time class="event__start-time" datetime="${dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateFrom).format(`YYYY-MM-DDTHH:mm`)}">${dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateFrom).format(`HH:mm`)}</time>
                  —
                  <time class="event__end-time" datetime="${dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateTo).format(`YYYY-MM-DDTHH:mm`)}">${dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateTo).format(`HH:mm`)}</time>
                </p>
...
class Event extends _smart__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(event) {
    super();
    this._data = event;
...
class EventList extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LoadingPlug; });
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");
...
class LoadingPlug extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NoEventsPlug; });
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");
...
class NoEventsPlug extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
const createSorting = (sortType) => {
  return `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
            <div class="trip-sort__item  trip-sort__item--day">
              <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-day"${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_DAY === sortType ? ` checked=""` : ``}>
            ...
            <div class="trip-sort__item  trip-sort__item--time">
              <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time"${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_TIME === sortType ? ` checked=""` : ``}>
              <label class="trip-sort__btn" for="sort-time">Time</label>
            </div>

            <div class="trip-sort__item  trip-sort__item--price">
              <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-price"${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].BY_PRICE === sortType ? ` checked=""` : ``}>
...
class Sorting extends _smart__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
const getDates = (points) => {
  return `${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(points[0].dateFrom).format(`MMM D`)}&nbsp;—&nbsp;${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(points[points.length - 1].dateTo).format(`MMM D`)}`;
};

const createTripInfo = (points) => {
  const sortedPoints = points.sort((a, b) => {
    return dayjs__WEBPACK_IMPORTED_MODULE_0___default()(a.dateFrom).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(b.dateFrom));
  });
...
class TripInfo extends _smart__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
    super();
  }
